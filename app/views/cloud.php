...
//		}, 4500);
	...
	<audio autoplay loop>
		 <source src="../public/sounds/bgm.mp3" type="audio/mpeg"> 
	</audio>
	<audio id="thunder">
		<source src="../public/sounds/thuder1.mp3" type="audio/mpeg">
	</audio>
	<div id="viewport" >
		<div id="world" >
			<div id="titleBase">
				<!-- <img id="title" src="http:/localhost/Takshak17/public/images/Takshak.png"/> -->
				<img id="title" src="../public/images/Takshak.png"/>
				<!-- <img id="logo" src="http:/localhost/Takshak17/public/images/logo.png" style="opacity:0"/> -->
				<img id="logo" src="../public/images/logo.png" style="opacity:0"/>
				<!-- <img id="comingSoon" src="http:/localhost/Takshak17/public/images/comingSoon.png" style="opacity:0"/> -->
				<img id="comingSoon" src="../public/images/comingSoon.png" style="opacity:0"/>
				<img id="Date" src="../public/images/Date.png" style="opacity:0"/>
				<!-- <img id="comingSoon" src="./images/comingSoon.png"/> -->
				<img class="cloudLayer bimg3" name="bimg3" style="opacity:1" src="../public/images/cloud.png"/>
				<img class="cloudLayer bimg3 lightning flashit" name="bimg3" style="opacity:1" src="../public/images/cloud.png"/>
				<img class="cloudLayer bimg3" name="bimg4" style="opacity:0.2" src="../public/images/cloud.png"/>
				<img class="cloudLayer bimg3 lightning flashit2" name="bimg4" style="opacity:1" src="../public/images/cloud.png"/>
	...
	function createCloud() {
		...
		for( var j = 0; j < 5 + size; j++ ) {
			...
			var r = Math.random();
			var src = '../public/images/cloud.png';
